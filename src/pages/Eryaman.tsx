              ...
              <div className="space-y-4 sm:space-y-5 md:space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-gray-600 break-words">Yeşilova, 4016. Cad. B Blok No:2/2/13, 06796 Etimesgut/Ankara</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-gray-600 break-all">roseweddinghall06@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-gray-600">660 kişi</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 sm:p-6 md:p-8 order-1 lg:order-2">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-sm sm:text-base text-gray-700">Yüksek Tavan</span>
                </div>
                <div className="flex items-center">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-primary mr-2 sm:mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm sm:text-base text-gray-700">Açık / Kapalı Otopark</span>
                </div>
              </div>

              <div className="mt-6 sm:mt-7 md:mt-8">
                <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Hizmetlerimiz</h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4">
                  <div className="text-xs sm:text-sm text-gray-600">• Düğün Organizasyonu</div>
                  <div className="text-xs sm:text-sm text-gray-600">• Nikah Töreni</div>
                  <div className="text-xs sm:text-sm text-gray-600">• Sünnet Düğünü</div>
                  <div className="text-xs sm:text-sm text-gray-600">• Doğum Günü</div>
                  <div className="text-xs sm:text-sm text-gray-600">• Kurumsal Etkinlik</div>
                  <div className="text-xs sm:text-sm text-gray-600">• Toplantı & Seminer</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-8 sm:py-12 md:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6 sm:mb-8 md:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Etimesgut Şubesi Galerisi</h2>
          </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8">
              ...
              <div className="space-y-4 sm:space-y-5 md:space-y-6">
                <div className="text-center">
                  ...
                  <a href="tel:+905386223050" className="text-sm sm:text-base text-gray-600 hover:text-primary transition-colors break-all">
                    +90 538 622 30 50
                  </a>
                </div>
                ...
                <div className="text-center">
                  ...
                  <a href="mailto:roseweddinghall06@gmail.com" className="text-sm sm:text-base text-gray-600 hover:text-primary transition-colors break-all">
